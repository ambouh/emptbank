...
function $ParseProvider() {
   ...
   *
   * - when building card-panel-views it's often desirable to receive the raw promises
 ...
 * browsers.  However, the parsed card-panel-views will not be set if the URL assigned did not specify
